...
var App = React.createClass({
    componentDidMount: function() {
        ...
        //script.src='https://www.googleapis.com/fusiontables/v1/query?sql=SELECT+Year,+Date,+Headline,+Description,+Image,+Color+%20+FROM+1m99v8KQi9AzND8nM8QrOG-h5O0kJR0LjqSZBmt9b+WHERE+Year=%27'+this.props.year+'%27+ORDER%20BY+Year&key=AIzaSyBBcCEirvYGEa2QoGas7w2uaWQweDF2pi0&callback='+cbname;
