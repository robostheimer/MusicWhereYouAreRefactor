...
.controller('formController', ['$scope', '$rootScope', 'retrieveLocation', 'getLocation', '$q', 'HashCreate', '$location','HintShower','$timeout',
function($scope, $rootScope, retrieveLocation, getLocation, $q, HashCreate, $location, HintShower, $timeout) {
	...
	$scope.hintShower = function(location) {
		...
		$timeout(function(){
			...
			HintShower.showHint($scope.type_location)
